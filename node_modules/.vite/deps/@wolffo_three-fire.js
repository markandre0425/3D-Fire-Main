...
// node_modules/@wolffo/three-fire/dist/index.esm.js
...
var FireShader = {
  ...
  uniforms: {
    fireTex: { value: null },
    color: { value: new Color(15658734) },
    time: { value: 0 },
    seed: { value: 0 },
...
var Fire = class extends Mesh {
  /**
   * Creates a new Fire instance
   *
   * @param props - Configuration options for the fire effect
   */
  constructor({ fireTex, color = 15658734, iterations = 20, octaves = 3, noiseScale = [1, 2, 1, 0.3], magnitude = 1.3, lacunarity = 2, gain = 0.5 }) {
...
var useTexture = (url) => useLoader(TextureLoader, url);
extend({ Fire });
var FireComponent = (0, import_react.forwardRef)(({ texture, color = 15658734, iterations = 20, octaves = 3, noiseScale = [1, 2, 1, 0.3], magnitude = 1.3, lacunarity = 2, gain = 0.5, autoUpdate = true, onUpdate, children, ...props }, ref) => {
  const fireRef = (0, import_react.useRef)(null);
  ...
  const fireProps = (0, import_react.useMemo)(() => ({
  ...
  useFrame((state) => {
    if (fireRef.current && autoUpdate) {
      ...
      onUpdate == null ? void 0 : onUpdate(fireRef.current, time);
    }
  });
  ...
  return (0, import_jsx_runtime.jsx)("fire", { ref: fireRef, args: [fireProps], ...props, children });
});
...
var useFire = () => {
  ...
  return {
    ...
    fire: ((_a = ref.current) == null ? void 0 : _a.fire) || null,
    /** Update fire animation manually */
    update: (time) => {
      var _a2;
      return (_a2 = ref.current) == null ? void 0 : _a2.update(time);
    }
  };
};
export {
  FireComponent as Fire,
  FireComponent,
  Fire as FireMesh,
  FireShader,
  useFire
};
//# sourceMappingURL=@wolffo_three-fire.js.map
